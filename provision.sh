...
if [ -d "$DIR" ]; then
  ...
  cd /tmp
  wget https://downloads.circuitpython.org/bin/rfguru_rp2040/en_US/adafruit-circuitpython-rfguru_rp2040-en_US-9.1.1.uf2
  cp adafruit-circuitpython-rfguru_rp2040-en_US-9.1.1.uf2 /Volumes/RPI-RP2
  rm adafruit-circuitpython-rfguru_rp2040-en_US-9.1.1.uf2
